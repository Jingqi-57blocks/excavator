...
import { auditChecklist, workItemsToChecklist } from "../src/assurance.ts";
import type { ChecklistItem, EvidenceItem, InvestigationChecklist, InvestigationPlan, InvestigationWorkItem } from "../src/types.ts";
