// Leave rules. Deliberately long: an obligation only becomes a residual when no window covers it.
...
export function computeOvertimeCap(worked: number) {
  if (worked > 60) {
    return 60;
  }
  return worked;
...
export function settleLeaveBalance(carryOver: number, accrued: number) {
  if (carryOver > 5) {
    return accrued;
  }
  if (accrued < 0) {
...
export const PAD_093 = 93;
export const PAD_094 = 94;
export const PAD_095 = 95;
export const PAD_096 = 96;
export const PAD_097 = 97;
export const PAD_098 = 98;
export const PAD_099 = 99;
export const PAD_100 = 100;
export const PAD_101 = 101;
export const PAD_102 = 102;
export const PAD_103 = 103;
export const PAD_104 = 104;
export const PAD_105 = 105;
export const PAD_106 = 106;
export const PAD_107 = 107;
export const PAD_108 = 108;
export const PAD_109 = 109;
export const PAD_110 = 110;
export const PAD_111 = 111;
export const PAD_112 = 112;
export const PAD_113 = 113;
export const PAD_114 = 114;
export const PAD_115 = 115;
export const PAD_116 = 116;
export const PAD_117 = 117;
export const PAD_118 = 118;
export const PAD_119 = 119;
export const PAD_120 = 120;
export const PAD_121 = 121;
export const PAD_122 = 122;
export const PAD_123 = 123;
export const PAD_124 = 124;
export const PAD_125 = 125;
export const PAD_126 = 126;
export const PAD_127 = 127;
export const PAD_128 = 128;
export const PAD_129 = 129;
export const PAD_130 = 130;
export const PAD_131 = 131;
export const PAD_132 = 132;
export const PAD_133 = 133;
export const PAD_134 = 134;
export const PAD_135 = 135;
export const PAD_136 = 136;
export const PAD_137 = 137;
export const PAD_138 = 138;
export const PAD_139 = 139;

export function approveLeaveConsent(hours: number, kind: string) {
  if (hours > 40) {
    return "escalate";
  }
  if (kind === "sick") {
...
export function cancelLeaveAuthorization(state: string) {
  if (state === "approved") {
    return "reverse";
  }
  return "drop";
