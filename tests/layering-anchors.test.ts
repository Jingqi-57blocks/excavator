...
const ANCHORS: Record<string, Classification> = {
  ...
  "src/assurance/checkpoint.ts": { kind: "current-file" },
  "src/base/assurance-version.ts": { kind: "current-file" },
  "src/assurance/section-audit.ts": { kind: "current-file" },
  "src/assurance/investigation-artifacts.ts": { kind: "current-file" },
