...
8. **第 7 层调查结果与第 8 层封存分片完成中。** P18 四级上界、content store、O(N) 单写者流、`ReadSpec` 执行 / 义务处置、completeness 逐域合取与 NotApplicable 前提验证已落地；剩余工作是 epoch 追加封存。
