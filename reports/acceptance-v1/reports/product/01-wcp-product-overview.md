...
**读取方式。** Excavator 扫描了 2,007 个 Git-aware 候选文件；其中 1,646 个被归为主要源码候选。CodeGraph 覆盖 94.96%（1,639/1,726），未覆盖文件和语义不足的部分通过受限源码窗口读取。`事实`
...
- `wcp-ui/src/main.tsx`
- `wcp-service-v2/main.go`
- `wcp-service-v2/init/initialization.go:31-161`
- `wcp-service/app.js:93-107`
- `wcp-service/common/scheduleService.js:18-141`
- `wcp_review_service/main.go`
- `wcp-auth/internal/handlers/handler.go:18-47`
- `wcp-service-v2/internal/constant/role.go:7-17`
