...
function renderCounters(stats: RunStats): string[] {
  ...
  if (c.codegraphCoverage) lines.push(`  codegraph:       ${c.codegraphCoverage.indexed}/${c.codegraphCoverage.eligible} indexed (ratio ${c.codegraphCoverage.ratio.toFixed(4)})`);
